        ...
        <div class= "tabel">
            <table border="1" bordercolor="#c9c9c9" width="100%" cellspacing ="0">
                ...
                <tr bgcolor="white">
                    ...
                    <td width="30px">
                    <a href="edit_department.php?id=<?php echo $row['id']?>"><button class="action"><i class="edit"></i></button></a>				
                    </td>
                    <td width="30px">
                    <a href="delete_department.php?id=<?php echo $row['id']?>"><button class="action"><i class="delete"></i></button></a>	
                    </td>
                </tr>
                <?php
                    }
