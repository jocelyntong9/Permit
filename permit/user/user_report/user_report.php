...
<!-- kontent -->
    ...
    <div class="print">
        ...
        <?php
            $head = $data['head_of_department'];
            $totaldata= "All";
            if (isset($_POST['totaldata'])) {
                $totaldata = $_POST['totaldata'];           
                if($totaldata == "All"){
                    $a->select("request_on_leave","*","id='$id_user' AND approvement_by='$head'");
                    $result = $a->sql;
                }else{
                    $a->select_limit("request_on_leave","*","id='$id_user' AND approvement_by='$head'","$totaldata");
                    $result = $a->sql;
                }
            ...
            elseif (isset($_POST['filter'])) {
                ...
                $b = new filter_date();
                $b->filter("request_on_leave","*",$date1,$date2,"id='$id_user' AND approvement_by='$head'");
                $result = $b ->sql;
