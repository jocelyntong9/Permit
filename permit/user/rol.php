...
if ($period != $interval){
    ...
    $a = new CRUD();
        ...
        'reason_of_leave'=>$rol,'approvement_by'=>$approvement_by]);
        if ($a == true) {
            echo "<script type='text/javascript'>alert('On Leave Form Submitted!');window.location.href='user_rol.php';</script>";
