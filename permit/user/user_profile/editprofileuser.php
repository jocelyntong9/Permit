            ...
            ?>
                ...
                <table border="0" bordercolor="#c9c9c9" width="100%" cellspacing ="0" class="table1">
                    ...
                    <td style="padding-bottom: 20px;">
                            <input class="photo" name="photo" value="<?php echo $data['photo'];?>" type="file" accept=".jpg,.jpeg,.png" required>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <div class="test2">
                    ...
                    <tr>
                        <td width="130px" style="padding-bottom: 20px">
                            <select name="department" id="department" class="form2" disabled>
                    ...
                    <tr>
                        <td colspan="3">
                            <button type="submit" name="update" class="save">Save Changes</button>  
                        </td>
                    </tr>
                </table>
                </form>
